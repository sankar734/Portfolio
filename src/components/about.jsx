...
//                   <Image src="./src/assets/Images/Profile.jpeg" style={{width:"60%", height:"60%"}} roundedCircle />
...
import ProfileImage from "../assets/Images/Profile.jpeg"; // path correct panniko
  ...
  return (
    ...
    >
      <Container className="py-5">
        <h1
          className="display-3 fw-bold text-center mb-5"
          style={{ color: "#2a11ee" }}
        >
          About Me
        </h1>
          ...
          <Col md={5} className="text-center mb-4">
            <Image
              ...
              style={{
                ...
                height: "300px",
                objectFit: "cover",
                border: "4px solid #1fa7e2",
              }}
            />
          </Col>

          <Col md={7}>
            <h2 className="mb-3" style={{ color: "#1fa7e2" }}>
              Hi, I'm Sankar S
            </h2>

            <p className="fs-5">
              I am a passionate Web Developer who enjoys creating dynamic and
              responsive websites. I have a strong foundation in front-end
              technologies and a keen interest in back-end development.
            </p>

            <p className="fs-5">
              I have experience with HTML, CSS, JavaScript, React, Bootstrap,
