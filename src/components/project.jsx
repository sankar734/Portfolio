        ...
        <Row className="align-items-center">
            <Col xs={12} md={4} className="text-center mb-4"> 
                ...
                <Card style={{ width: '25rem',objectFit: 'cover' }}>
                    <Card.Img variant="top" src="./src/assets/Images/img3.png" className="p-4 rounded-5" />
                    <Card.Body>
            ...
            <Col xs={12} md={4} className="text-center mb-4 ">
                ...
                <Card style={{ width: '25rem',objectFit: 'cover' }}>
                    <Card.Img variant="top" src="./src/assets/Images/img4.png" className="p-4 rounded-5" />
                    <Card.Body>
            ...
            <Col xs={12} md={4} className="text-center mb-4 ">
                ...
                <p className="fs-5">This project is a web-based application that allows users to manage college events. It provides features such as event creation, registration management, and event scheduling.</p> */}
                <Card style={{ width: '25rem',objectFit: 'cover' }} >
                    <Card.Img variant="top" src="./src/assets/Images/img5.png" className="p-4 rounded-5" />
                    <Card.Body>
